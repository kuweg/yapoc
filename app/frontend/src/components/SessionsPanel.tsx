...
export function SessionsPanel() {
  ...
  if (sorted.length === 0) {
    // An empty state that knows what you want should offer it, not send you to
    // another tab to find the button.
    return (
      <div className="flex-1 flex flex-col items-center justify-center gap-3 text-center px-6">
        <p className="text-zinc-300 text-sm font-mono">No conversations yet</p>
        <p className="text-zinc-500 text-[13px] font-mono max-w-sm">
          Sessions are saved automatically — start one and it will show up here with
          its history, cost and export options.
        </p>
        <button
          onClick={() => { newSession(); setActiveTab('chat') }}
          className="mt-1 px-4 py-2 bg-zinc-700 text-zinc-100 text-xs font-mono tracking-wider border border-zinc-600 hover:bg-zinc-600 transition-colors"
        >
          + START A SESSION
        </button>
      </div>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-3 mb-4">
          ...
          <button
            ...
            disabled={anyBusy}
            className="px-2 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-400 hover:text-[#FFB633] hover:border-[#FFB633] disabled:opacity-40 disabled:cursor-not-allowed"
          >
        ...
        {selectedCount > 0 && (
          <div className="mb-4 flex items-center gap-2 px-3 py-2 border border-[#FFB633]/40 bg-[#1a1408]">
            ...
            <button
              ...
              disabled={anyBusy}
              className="px-2 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-200 hover:text-[#FFB633] hover:border-[#FFB633] disabled:opacity-40 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={anyBusy}
              className="px-2 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-300 hover:text-red-400 hover:border-red-500 disabled:opacity-40 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={anyBusy}
              className="px-2 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-400 hover:text-zinc-200 hover:border-zinc-500 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Clear
            </button>
          </div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  disabled={anyBusy}
                  className="px-2 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-400 hover:text-red-400 hover:border-red-500 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  Delete
                </button>
              </li>
