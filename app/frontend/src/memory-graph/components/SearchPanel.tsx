  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950 text-zinc-100">
      <div className="flex items-center gap-3 px-4 py-2 border-b border-zinc-800 flex-shrink-0">
        <h2 className="text-[12px] uppercase tracking-widest text-zinc-500">
          Semantic Search
        </h2>
        <form onSubmit={submit} className="flex-1 flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-200 hover:text-[#FFB633] hover:border-[#FFB633] disabled:opacity-40 disabled:cursor-not-allowed"
          >
        ...
        <button
          onClick={onClose}
          className="px-2 py-1 text-[13px] font-mono uppercase tracking-wider border border-zinc-700 text-zinc-400 hover:text-zinc-200 hover:border-zinc-500"
        >
          Close
        </button>
      </div>
        ...
        {data && data.results.length > 0 && (
          <div className="space-y-2">
            ...
            {data.results.map((hit, i) => (
              ...
              >
                <div className="flex items-center gap-2 text-[13px] font-mono mb-1">
