...
MODELS: list[ModelInfo] = [
    ...
    ModelInfo(
        ...
        pricing_notes='Public catalog snapshot; routed endpoint prices and availability may differ. USD per million tokens, excluding tools and fees.',
    ...
    ModelInfo(
        ...
        max_output=8_192,
        input_price=0.29,
        output_price=1.1400000000000001,
        pricing_source='https://openrouter.ai/api/v1/models',
        pricing_verified_at='2026-09-09',
        pricing_notes='Public catalog snapshot; routed endpoint prices and availability may differ. USD per million tokens, excluding tools and fees.',
